...
{
    /// <summary>
    /// Improved template manager that centralizes template handling.
    /// </summary>
    public class TemplateManagerV2
    {
        ...
        public TemplateManagerV2(ILogger logger)
        {
...
";
        ...
        private string ResolveTemplatePath(string templateName)
        {
            ...
            var possiblePaths = new[]
            {
                ...
                Path.Combine(
                    Path.GetDirectoryName(typeof(TemplateManagerV2).Assembly.Location) ?? "",
                    "Config",
                    "Templates",
